...
class SupportController extends Controller
{
    ...
    {
        $this->validate($request, [
            'file' => 'required|mimes:docx,pdf,doc,txt,jpg,jpeg,png,gif,svg,mp4,mp3,avi,flv,wmv,mov,webm,ogg,qt,wmv,mpg,mpeg,3gp,3g2,zip,rar|max:102400', // 102400 KB = 100 MB
        ]);
