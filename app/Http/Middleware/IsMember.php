...
class IsMember
{
    ...
    {
        if(auth()->user()->is_employee == 5){
            $ip_address = $request->ip();
            $current_ip = Session::get('login_ip');
            $ip_address_array = ['202.47.32.22', '113.203.241.253', '206.42.123.75', '139.190.235.87', '202.47.34.48', '202.47.32.22', '39.48.206.139', '39.48.194.97', '39.48.195.213', '182.184.119.166', '127.0.0.1'];
            if($current_ip != null){
