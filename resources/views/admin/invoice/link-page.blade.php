                        ...
                        <div id="print-area">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0">#{{$_getInvoiceData->invoice_number}}</p>
                                    @if($_getInvoiceData->merchant != null)
                                    <span class="badge badge-info">{{ $_getInvoiceData->merchant->name }}</span>
                                    @endif
                                </div>
                                <div class="col-md-6 text-sm-right">
                                    <p class="mb-0">
                                        ...
                                        <span>
                                            {{  App\Models\Invoice::PAYMENT_STATUS[$_getInvoiceData->payment_status] }}
                                            {{ $_getInvoiceData->return_response != null ? '- ' . $_getInvoiceData->return_response : '' }}
                                        </span>
                                    </p>
                                    <p class="mb-0"><strong>Invoice date: </strong>{{ $_getInvoiceData->created_at->format('d M, y h:i a') }}</p>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('client.paynow', $_getInvoiceData->invoice_id) }}" target="_blank" class="btn btn-primary">Invoice Link</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
