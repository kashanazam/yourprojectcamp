...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card text-left">
            <div class="card-body">
                <form action="/admin/generate/ticket" method="POST" id="ticket-form">
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="deliverable[]" class="form-check-input" id="p1" style="margin-top: 0.2rem;" value="Product/Deliverables Issue/Wrong">
                                        <label class="form-check-label" for="p1">Product/Deliverables Issue/Wrong</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="deliverable[]" class="form-check-input" id="p2" value="Product not as described/agreed" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="agent_related[]" class="form-check-input" id="a1" value="Agent Issue/Misbehavior/Fraud attempt/Manipulation/Threat" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="a1">Agent Issue/Misbehavior/Fraud attempt/Manipulation/Threat</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="agent_related[]" class="form-check-input" value="Agent pretending to be from another entity/organization" id="a2" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="production_related[]" value="Deliverables Issue" class="form-check-input" id="d1" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="d1">Deliverables Issue</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="production_related[]" value="Printed Copies +100" class="form-check-input" id="d2" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="communication[]" class="form-check-input" id="c1" style="margin-top: 0.2rem;" value="Descriptor not communicated">
                                        <label class="form-check-label" for="c1">Descriptor not communicated</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="communication[]" class="form-check-input" id="c2" value="Upsell attempted, Customer not Interested" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="c2">Upsell attempted, Customer not Interested</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="communication[]" value="Wrong TAT communicated/committed" class="form-check-input" id="c3" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="c3">Wrong TAT communicated/committed</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="communication[]" class="form-check-input" value="Package details are not shared via email" id="c4" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="c4">Package details are not shared via email</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="communication[]" value="No communication found" class="form-check-input" id="c5" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="customer_legal[]" value="Chargeback/Refund/Legal threat" class="form-check-input" id="r1" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="r1">Chargeback/Refund/Legal threat</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="customer_legal[]" value="Customer asking for Refund" class="form-check-input" id="r2" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="r2">Customer asking for Refund</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="customer_legal[]" value="Chargeback/payment dispute Process guided to the customer" class="form-check-input" id="r3" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="r3">Chargeback/payment dispute Process guided to the customer</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="customer_legal[]" value="Customer has potential for chargeback" class="form-check-input" id="r4" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="service_delivery[]" value="Delay in service delivery/deliverables" class="form-check-input" id="s1" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="s1">Delay in service delivery/deliverables</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="service_delivery[]" value="Forced/Unauthorized Sale or payment charged" class="form-check-input" id="s2" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="s2">Forced/Unauthorized Sale or payment charged</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="service_delivery[]" value="Dissatisfied With Services" class="form-check-input" id="s3" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="s3">Dissatisfied With Services</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="service_delivery[]" value="100% Refund committed to contract" class="form-check-input" id="s4" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="operational[]" value="Customer not created" class="form-check-input" id="o1" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="o1">Customer not created</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="operational[]" value="Task not Created" class="form-check-input" id="o2" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="o2">Task not Created</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="operational[]" value="Project not created" class="form-check-input" id="o3" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="o3">Project not created</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="operational[]" value="Task Pending" class="form-check-input" id="o4" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="special_case[]" value="Fraud Client (previously had CB/Refund history)" class="form-check-input" id="i1" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="i1">Fraud Client (previously had CB/Refund history)</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="special_case[]" value="Skeptical Client/Dissatisfied customer" class="form-check-input" id="i2" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="i2">Skeptical Client/Dissatisfied customer</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="special_case[]" value="ROI Commitment" class="form-check-input" id="i3" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="i3">ROI Commitment</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="special_case[]" value="Barnes & Nobles/Physical Book Store Sales" class="form-check-input" id="i4" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="i4">Barnes & Nobles/Physical Book Store Sales</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="special_case[]" value="Amazon Affiliation" class="form-check-input" id="i5" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="financial[]" value="Undercharged Product" class="form-check-input" id="f1" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="f1">Undercharged Product</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="financial[]" value="Conflicting amount" class="form-check-input" id="f2" style="margin-top: 0.2rem;">
                                        <label class="form-check-label" for="f2">Conflicting amount</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="financial[]" value="Payment Debit/Credit Card Blocked" class="form-check-input" id="f3" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="qa_varified" value="QA Verified" class="form-check-input" id="v1" style="margin-top: 0.2rem;">
                        ...
                        <div class="col-md-4 form-group mb-3">
                            ...
                            <select name="level" class="form-control" required>
                                <option value="" selected disabled>Select Security Level</option>
                                <option value="Low" style="color: #fff;" class="bg-default">Low</option>
                                <option value="High" style="color: #fff;" class="bg-warning">High</option>
                                <option value="Critical" style="color: #fff;" class="bg-danger">Critical</option>
                            </select>
                        </div>
                        <div class="col-md-4 form-group mb-3">
                            ...
                            <select name="status" class="form-control" required>
                                ...
                                <option value="Open" style="color: #fff;" class="bg-danger">Open</option>
                                <option value="In Progress" style="color: #fff;" class="bg-warning">In Progress</option>
                                <option value="Closed" style="color: #fff;" class="bg-success">Closed</option>
                            </select>
                        </div>
                    ...
                    <table class="display table table-striped table-bordered" id="zero_configuration_table"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach (json_decode($issue->user_id, true) as $userId)
                                        @php
                                            $user = \App\Models\User::find($userId);
                                        @endphp
                                        @if ($user)
                                            <span class="btn btn-sm btn-secondary">{{ $user->name }}</span>
                                        @endif
                                    @endforeach
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('admin.issue.show', $issue->id) }}" class="btn btn-secondary btn-sm">View</a>
                                    <a href="{{ route('admin.issue.edit', $issue->id) }}" class="btn btn-warning btn-sm">Edit</a>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < getData.length; i++) {
                        ...
                        var role = getData[i].is_employee == 6 ? 'Sale Manager' : 'Project Manager';
