...
<body>
            ...
            <div class="col-lg-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <input class="form-control mb-3" id="card-holder-name" name="card_holders_name" placeholder="Name on card" required />
    ...
    <script type="text/javascript">
        ...
        const key = '{{ $_getInvoiceData->merchant->public_key }}';
        ...
        const cardButton = document.getElementById('form-submit-btn');
        ...
        form.addEventListener('submit', async (event) => {
            if ($('.card-wrapper').hasClass('d-none')) {
                form.submit();
            }
            ...
            stripe.createPaymentMethod({
                ...
                if (!$('.card-wrapper').hasClass('d-none')) {
                    if (result.error) {
                        $('#card-error').addClass('alert alert-danger').text(result.error.message);
                    } else {
        ...
        const stripeSourceHandler = (source) => {
            ...
            hiddenInput.setAttribute('name', 'paymentMethods');
        ...
        //                 const stripe = Stripe($form.data('stripe-publishable-key'));
