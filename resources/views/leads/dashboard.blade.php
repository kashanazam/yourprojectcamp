            ...
            <div class="card">
                ...
                <div class="card-body px-0">
                    <div class="px-3" data-simplebar style="max-height: 386px;">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="./images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="avatar-md me-4">
                                <img src="./images/users/avatar-8.jpg" class="img-fluid rounded-circle" alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center pb-3">
                            <div class="avatar-md me-4">
                                <img src="./images/users/avatar-9.jpg" class="img-fluid rounded-circle" alt="">
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <h5 class="font-size-15"><a href="" class="text-dark">Light blue T-shirt</a>
                                            </h5>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="./images/product/img-3.png" class="img-fluid" alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="./images/product/img-4.png" class="img-fluid" alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="./images/product/img-5.png" class="img-fluid" alt="">
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="./images/product/img-6.png" class="img-fluid" alt="">
                                        </div>
                                    </td>
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        <img src="images/users/avatar-3.jpg" class="rounded-circle avatar-sm" alt="">
                                        <div class="flex-1">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <div class="conversation-name"><span class="time">10:00 AM</span>
                                                    </div>
                            ...
                            <li class="right">
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        ...
                                        <img src="images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="">
                                    </div>
                                ...
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <div class="conversation-name"><span class="time">10:04 AM</span>
                                                    </div>
                                                    <p class="mb-0">
                                        ...
                                        <div class="flex-1">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    ...
                                                    <p class="mb-0">
                                                        Waiting for your reply.As I heve to go back soon. i have to
                                ...
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        <div class="flex-1">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <div class="conversation-name"><span class="time">10:08 AM</span>
                                                    </div>
                                                    <p class="mb-0">
                                ...
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <div class="conversation-name"><span class="time">10:06 AM</span>
                                                    </div>
                                                    <p class="mb-0">
                                ...
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <div class="conversation-name"><span class="time">10:09 AM</span>
                                                    </div>
                                                    <p class="mb-0">
