            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <a href="{{ route('production.task.show', $subtask->task->id . '#' . $subtask->subtask->id) }}" class="btn btn-info btn-sm">View Main Task Details</a>
                    </div>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="separator-breadcrumb border-top mb-3"></div>
                    <form class="form" action="{{route('production.member.subtask.store')}}" method="POST" id="subtask" enctype="multipart/form-data">
                        @csrf
...
<script>
    $(document).ready(function(){
        ...
        $("#image-file").fileinput({
            ...
            uploadUrl: "{{ route('production.member.insert.files', ['id' => $subtask->task->id, 'subtask_id' => $subtask->subtask_id]) }}",
